...
export default function CartDetails({
  ...
  return (
    <section className="bg-light-purple absolute left-0 right-0 h-[572px] flex flex-col justify-center items-center py-20 ">
      <div className="flex flex-col w-[473px] gap-10 z-10">
        ...
        <button
          className="text-white bg-dark-purple rounded-xl py-5 font-bold text-xl mt-4"
          onClick={() => {
            handleEmptyCart();
          }}
        >
        ...
        <Link href="/books" className="text-dark-purple text-center mt-4">
          خرید بیشتر
        </Link>
      </div>
